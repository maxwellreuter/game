...
public class Loader {
	...
	private final float MIPMAP_BIAS = -0.7f; // more negative means higher quality, lower performance
	...
	private IntBuffer storeDataInIntBuffer(int[] data) {
		...
		buffer.put(data);
		buffer.flip(); // prepare buffer to be read from (as opposed to written to)
		return buffer;
	}
